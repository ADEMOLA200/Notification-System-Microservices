...
const { processEmailNotification } = require('./services/emailProcessor');
...
app.get('/health', async (req, res) => {
  try {
    ...
    const { getCircuitBreakerStats } = require('./services/emailProcessor');
...
async function startServer() {
  try {
    ...
    await consumeQueue('email.queue', processEmailNotification);
